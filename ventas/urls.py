...
from .views import VentaView, DetalleVentaView, ComprobanteVentaView, ClienteView, VentaReporteView, VentasPorInventarioViewSet, VentaListViewSet
...
router.register(r'ventas-list', VentaListViewSet, basename='ventas-list')
